<template>
  <div>
    ...
    <div class="row">
      ...
      <div class="col-xs-11">
        <input v-model="newTask.name" class="form-control col-xs-6"  placeholder="name">
        <input v-model="newTask.priority" class="form-control col-xs-3" placeholder="priority"> 
        <input type="date" v-model="newTask.deadline" class="form-control col-xs-3" placeholder="deadline">
      </div>
